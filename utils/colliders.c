...
void get_circle_collider_on_spritecenter(collider_t *collider,
entity_t *entity)
{
    sfVector2f center = get_sprite_center(entity);

    collider->position = center;
    sfCircleShape_setPosition(collider->circ_collider, center);
}